...
\lstset{caption={Przykład funkcji, która wykonuje daną komendę termonalową przy użyciu OS}}
\begin{lstlisting}
...
\lstset{caption={Przykład kopiowania tensora utworzonego z CPU do GPU, kod ten zwraca nowy tensor, który ma te same dane liczbowe, ale jest przechowywany w pamięci RAM GPU, a nie w zwykłej pamięci RAM systemu.}}
\begin{lstlisting}
